...
const ListOrganizationProjectMemberActivitiesParametersSchema = z.object({
...
export type ListOrganizationProjectMemberActivitiesInput = z.input<typeof ListOrganizationProjectMemberActivitiesParametersSchema>
export type ListOrganizationProjectMemberActivitiesParameters = z.output<typeof ListOrganizationProjectMemberActivitiesParametersSchema>

export async function listOrganizationProjectMemberActivities(
  dependencies: { db: DbOrTx },
  executor: OrganizationExecutor,
  input: ListOrganizationProjectMemberActivitiesInput,
) {
  const result = ListOrganizationProjectMemberActivitiesParametersSchema.safeParse(input)
