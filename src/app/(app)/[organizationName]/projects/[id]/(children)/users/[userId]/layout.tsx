...
export default function UserLayout({ children }: { children: React.ReactNode }) {
  const { id: projectId, userId, organizationName } = useParams<{ id: string; userId: string; organizationName: string }>()
  ...
  const basePath = `/${organizationName}/projects/${projectId}/users/${userId}`
