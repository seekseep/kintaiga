...
export const Route = createFileRoute('/_app/$organizationName/configuration/activities')({
        ...
        >
          {({ handleSubmit, values }) => (
            <form onSubmit={(e) => { e.preventDefault(); handleSubmit() }} className="space-y-4">
              <FormSelect name="roundingInterval" label="丸め間隔（分）" placeholder="選択してください" options={intervalOptions} />
              <FormSelect
