    ...
    <OrganizationRoleGuard allowedRoles={['owner', 'manager']}>
      <div className="mx-auto max-w-lg space-y-4">
        ...
        <div className="divide-y rounded-md border">
          <Link to={`${orgPath}/configuration/display-name`} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors">
          ...
          <Link to={`${orgPath}/configuration/name`} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors">
          ...
          <Link to={`${orgPath}/configuration/activities`} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors">
            <ClockIcon className="h-5 w-5 text-muted-foreground" />
            <span className="flex-1">稼働の設定</span>
            <ChevronRightIcon className="h-5 w-5 text-muted-foreground" />
          </Link>
          <Link to={`${orgPath}/configuration/export`} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors">
            <DownloadIcon className="h-5 w-5 text-muted-foreground" />
            <span className="flex-1">データのエクスポート</span>
            <ChevronRightIcon className="h-5 w-5 text-muted-foreground" />
          </Link>
          <Link to={`${orgPath}/configuration/import`} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors">
        ...
        <div className="divide-y rounded-md border border-destructive/30">
          <Link to={`${orgPath}/configuration/delete`} className="flex items-center gap-3 px-4 py-3 hover:bg-destructive/5 transition-colors text-destructive">
