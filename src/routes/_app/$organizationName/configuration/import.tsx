...
export const Route = createFileRoute('/_app/$organizationName/configuration/import')({
  component: ImportOrganizationPage,
})

function ImportOrganizationPage() {
        ...
        {result ? (
          <Card>
            ...
            <CardContent className="space-y-4">
                  ...
                  {result.skipped.missingMembers.length > 0 && (
                    <div>
                      <p className="text-yellow-900">
                        この組織に存在しないメンバーが参照されています。先にメンバーを追加して再実行してください:
                      </p>
              ...
              <Button className="w-full" onClick={() => navigate({ to: `${orgPath}/projects` })}>
                プロジェクト一覧へ
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full" disabled={!payload || isImporting} onClick={handleSubmit}>
